...
\begin{figure}[H]
    ...
    The radii are the uncertainties of the estimates associated with different eigenvalues of the \ac{fim} $\lambda_1$, $\lambda_2$.
    The D-optimality aims to minimize the volume of the ellipsoid, the E-optimality minimizes the largest radius, the A-optimality minimizes the rectangle in which the ellipse is located (dotted line), and, finally,  Modified E-optimality tends to make the ellipse as spherical as possible.}}
