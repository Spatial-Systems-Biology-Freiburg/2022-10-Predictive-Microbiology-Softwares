...
If this test is not passed, the reader should either reconsider the model structure including the definition of parameters or increase the number of numerically optimised measurement conditions (inputs or times).
...
We would like to estimate the parameters of the model and determine optimal measurement conditions.
...
In our Experimental Design optmisation routine, we use the D-optimality criterion, relative sensitivities, and the differential evolution optimisation method.
The identifiability test confirmes the validity of our model setup (Fig.~\ref{fig:identif_check}).
...
This maximises the determinant of the fisher information matrix.
%
%
%
\begin{figure}[H]
...
In summary, we accelerate and simplify the planning of efficient experiments for parameter estimation in microbiology.
%
%
%
% ########################################################################
