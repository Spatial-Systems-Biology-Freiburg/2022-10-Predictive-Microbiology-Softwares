...
To make this chapter self-consistence we provide a Python software {\it eDPM} for Ordinary Differential Equation-based models.\\
...
There are several software packages available for model-based experimental design \cite{}. 
...
In the following, we will append more code to it and utilise the methods developed in eDPM~\cite{}.
