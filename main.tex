...
There results can be explained with local sensitivity curves where each of the chosen time points correspond to an extreme of at least one sensitivity (see Fig. \ref{fig:baranyi_roberts_sensitivities}).
...
\begin{figure}[H]
    \begin{subfigure}{.5\textwidth}
        ...
        \subcaption{{\footnotesize Specie 1, $T = 2^\circ$C, $t=70 \text{h}, 100$h}}
      \end{subfigure}   
    \begin{subfigure}{.5\textwidth}
        \centering
    ...
    \subcaption{{\footnotesize Specie 1, $T = 12^\circ$C, $t=13 \text{h}, 78$h}}
    \end{subfigure}
      \begin{subfigure}{.5\textwidth}
        \centering
    ...
    \subcaption{{\footnotesize Specie 2, $T = 2^\circ$C, $t=70 \text{h}, 100$h}}  
    \end{subfigure}
    %\end{figure}%
    ...
    \begin{subfigure}{.5\textwidth}
        ...
        \subcaption{{\footnotesize Specie 2, $T = 12^\circ$C, $t=13 \text{h}, 78$h}}  
    \end{subfigure}   
    ...
    (a), (c) show the first experimental series held at the temperature $T_1=2^\circ$C and with measurement times $t_{11}=70$h, $t_{12}=100$h for observables $x_1$ and $x_2$, respectively.
    (b), (d) show the second experimental series held at the temperature $T_2=12^\circ$Cand with measurement times $t_{21}=13$h, $t_{22}=78$h for observables $x_1$ and $x_2$, respectively.
    The line plot presents the model solution for the observable, and the circles determine the suggested by Experimental Design time points.
    [SEHT MEINE KOMMENTARE BEI DEN ANDEREN BILDERN.]}}
    \label{fig:baranyi_roberts_2species_observable}
\end{figure}

\cmt{??} The presented Design shows that the least needed number of experiments is two with temperatures of $2^\circ$C and $12^\circ$C.
