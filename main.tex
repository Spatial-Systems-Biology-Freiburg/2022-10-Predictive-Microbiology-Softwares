...
\begin{figure}[H]
    \begin{subfigure}{.5\textwidth}
        \centering
        \subcaption{Species 1, $T = 12^\circ$C, $t=0 \text{h}, 12 \text{h}, 71$h}
        \includegraphics[scale=0.25]{Figures/Fig9a.pdf}
      \end{subfigure} 
    \begin{subfigure}{.5\textwidth}
        \centering
        \subcaption{Species 1, $T = 2^\circ$C, $t=0 \text{h}, 58 \text{h}, 90$h}
        \includegraphics[scale=0.25]{Figures/Fig9b.pdf}
    \end{subfigure}
      \begin{subfigure}{.5\textwidth}
        \centering
        \subcaption{Species 2, $T = 12^\circ$C, $t=0 \text{h}, 12 \text{h}, 71$h}
        \includegraphics[scale=0.25]{Figures/Fig9c.pdf}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \subcaption{Species 2, $T = 2^\circ$C, $t=0 \text{h}, 58 \text{h}, 90$h}
